...
package com.Application.robotlegs.views.packedList.listPacked
{
	 ...
	 */
	public class DragDropPackedListEvent extends Event
	{
		/**
	...
	//	public static const DROPPED_OUT_SIDE:String = "DROPPED_OUT_SIDE";
		/**
		 * Constructor.
		 */
		public function DragDropPackedListEvent(type:String, dragData:DragData, isDropped:Boolean, localX:Number = NaN, localY:Number = NaN)
		{
